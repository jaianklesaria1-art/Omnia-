...
export function MissionVision() {
  ...
  return (
    <section className="relative px-6 md:px-12 max-w-7xl mx-auto pt-10 lg:pt-16 pb-8 lg:pb-12 bg-white">
      <div ref={ref} className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <motion.div
          initial={{ opacity: 0, y: 50 }}
          animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 50 }}
          transition={{ duration: 0.8 }}
          className="bg-gray-50 p-6 md:p-16 border-l-4 border-omnia-red hover:bg-black/5 transition-colors"
        >
        ...
        <motion.div
          ...
          className="bg-white p-6 md:p-16 hover:bg-gray-100 transition-colors"
        >
