...
export function CallToAction() {
  ...
  return (
    <section className="py-16 lg:py-32 bg-gray-50 relative overflow-hidden border-y border-black/5">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        <div ref={ref} className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-gray-600 font-sans text-base md:text-lg mb-8 md:mb-10">
          ...
          >
            <div className="relative w-full max-w-sm aspect-square md:w-80 md:h-80 rounded-2xl overflow-hidden shadow-2xl">
              <img 
                src="https://ik.imagekit.io/jai777/Dharmik/events/Gemini_Generated_Image_qanvugqanvugqanv.png" 
