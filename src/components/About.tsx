...
export function About() {
  ...
  return (
    <section id="about" className="py-16 lg:py-32 bg-[#ffffff] relative overflow-hidden">
        ...
        <div ref={ref} className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            <motion.div
              ...
              className="relative z-10 bg-[#ffffff] p-6 md:p-12 border-l-4 border-omnia-red transform md:-translate-x-8 md:translate-y-8"
            >
              <h4 className="text-xl md:text-2xl font-heading font-bold text-omnia-black mb-4 uppercase">Our Mission</h4>
              <p className="text-omnia-black font-sans text-sm md:text-base">
            ...
            <motion.div
              ...
              className="relative z-0 bg-[#ffffff] p-6 md:p-12 mt-8 md:mt-0 md:absolute md:top-32 md:right-0 md:w-4/5"
            >
